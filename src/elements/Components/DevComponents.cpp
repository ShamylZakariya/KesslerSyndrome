...
#pragma mark - TargetTrackingViewportController
    ...
    TargetTrackingViewportControlComponent::TargetTrackingViewportControlComponent(shared_ptr<TrackingTarget> target, elements::ViewportControllerRef viewportController, int dispatchReceiptIndex)
    :
    InputComponent(dispatchReceiptIndex),
    _viewportController(viewportController),
