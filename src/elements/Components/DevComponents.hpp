...
namespace elements {
    ...
    public:
        ...
        TargetTrackingViewportControlComponent(shared_ptr<TrackingTarget> target, elements::ViewportControllerRef viewportController, int dispatchReceiptIndex = 1000);
        
        TargetTrackingViewportControlComponent(elements::ViewportControllerRef viewportController, int dispatchReceiptIndex = 1000);
