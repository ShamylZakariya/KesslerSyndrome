...
namespace core {
    ...
    public:
        ...
        double getHealthiness() const {
            return max(_config.health / _config.maxHealth, 0.0);
        }
        ...
        double getMaxHealth() const {
            return _config.maxHealth;
        }

        void setMaxHealth(double mh) {
            _config.maxHealth = mh;
        }

        double getRegenerationRate() const {
            return _config.regenerationRate;
        }

        void setRegenerationRate(double rr) {
            _config.regenerationRate = rr;
        }
    ...
    public:
        ...
        virtual double getHealthiness() const {
            return _healthiness;
        }
        ...
        virtual double getDeathCycleProgress() const {
            return _deathCycleProgress;
        }
    ...
    public:
        ...
        HealthComponentRef getHealthComponent() const {
